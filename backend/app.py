...
def summaryAI():
    ...
    # 角色提示词
    role_prompt = """
        你是一名经验丰富的高中教育专家和教育心理学顾问，
        擅长根据学生学习数据和行为特征提供个性化学习建议。
    """
    # 任务提示词
    task_prompt = """
        请根据提供的学生画像数据进行分析，并从以下三个方面给出建议：
    ...
    data_prompt = f"""
        ...
        {fileContent}
    """
    words = role_prompt + task_prompt + format_prompt + data_prompt
